...
router.post("/getcashslips",auth, async (req, res,next) => {
  ...
  console.log(firmname,"dgdfdjfdkd");
  console.log(branchname,"dgdfdjfdkd");
  console.log(accountno,"dgdfdjfdkd");
  console.log(date,"dgdfdjfdkd");
  console.log(totalamount,"dgdfdjfdkd");
  console.log(twothousandqty,"dgdfdjfdkd");
  console.log(twothousandamount,"dgdfdjfdkd");
  console.log(fivehundredqty,"dgdfdjfdkd");
  console.log(fivehundredamount,"dgdfdjfdkd");
  console.log(twohundredqty,"dgdfdjfdkd");
  console.log(twohundredamount,"dgdfdjfdkd");
  console.log(onehundredqty,"dgdfdjfdkd");
  console.log(onehundredamount,"dgdfdjfdkd");
  console.log(fiftyqty,"dgdfdjfdkd");
  console.log(fiftyamount,"dgdfdjfdkd");
  console.log(twentyqty,"dgdfdjfdkd");
  console.log(twentyamount,"dgdfdjfdkd");
  console.log(tenqty,"dgdfdjfdkd");
  console.log(tenamount,"dgdfdjfdkd");
  console.log(fiveqty,"dgdfdjfdkd");
  console.log(fiveamount,"dgdfdjfdkd");
  
  console.log(coinsamount,"dgdfdjfdkd");
